package com.cs.roomdbapi.config.filter;
...
public class ApiLoggingFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        try {
            ...
            String logRequest = "REQUEST_ID: " + requestId +
                    " Splr: " + httpServletRequest.getRemoteUser() +
                    " HTTP " + httpServletRequest.getMethod() + " \"" + httpServletRequest.getServletPath() +
            ...
            try {
                ...
                String logResponse = "REQUEST_ID: " + requestId + " HTTP RESPONSE " + bufferedResponse.getContent();
    ...
    private Map<String, String> getTypesafeRequestMap(HttpServletRequest request) {
        ...
        while (requestParamNames.hasMoreElements()) {
            ...
            if (requestParamName.equalsIgnoreCase("supplierSecret")) {
                requestParamValue = "********";
            } else {
